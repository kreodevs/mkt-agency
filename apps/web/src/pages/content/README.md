...
Componentes: `@/components/content/` — `VersionHistory`, `SignatureBadge`, `ApprovalActions`, `ContentPlatformBadge` (tokens neutros), `ContentVisualDesignPanel`, `ContentVisualPanel`.
