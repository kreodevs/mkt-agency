...
| `/agents/competitor-intel` | Historial + reporte + nuevo análisis; búsqueda IA de competidores si no hay registros (**SOHO:** menú Copiloto → «Análisis competidores», alias `/copilot/competitors`) |
