...
| `ProductMediaKitPanel` | Kit de medios reales (capturas, eventos, demos) — subida directa o **Desde librería** (carpetas PC/iPad/iOS) en `/products/:id/media-kit`. **Resumen del kit** arriba (conteo por rol, clic para filtrar), **Rol al subir**, **Filtrar por rol**, edición inline de rol/etiqueta. Clic en miniatura o **Ver** → `AssetPreviewDialog` + descarga. |
