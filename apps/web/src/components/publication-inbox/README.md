...
| `InboxQuickPublishActions.tsx` | Copiar, Abrir red, **Regenerar escena** (IA/mockup, mismo copy), **Recomponer** (solo plantillas tipográficas), menú «Más» con **Regenerar post completo** (copy + visual); n8n en `InboxArtPublishBar` |
