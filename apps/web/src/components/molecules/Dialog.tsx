    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ref={ref}
          data-dialog-content
          className={`fixed left-1/2 top-1/2 z-[var(--z-modal)] flex max-h-[90vh] w-full -translate-x-1/2 -translate-y-1/2 flex-col overflow-visible ${sizeStyles[size]} rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--card)] shadow-xl ${className}`}
        ...
        >
          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-[var(--spacing-lg)] py-[var(--spacing-md)]">
            {children}
          </div>
