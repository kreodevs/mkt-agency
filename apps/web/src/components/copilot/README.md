...
| `CmCharacterSetupPanel.tsx` | Biblioteca de CMs: crear, editar apariencia en borrador local, guardar con «Guardar apariencia», retrato (IA o assets), preview lip-sync |
