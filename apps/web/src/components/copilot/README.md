...
| Archivo | Rol |
|---------|-----|
| `CopilotStatusPanel.tsx` | Panel en bandeja: pipeline + selector día/semana + preparar contenido + plantillas. Usa `AiThinkingPanel` (ThinkingOrb) al cargar, analizar competencia o preparar semana. |
