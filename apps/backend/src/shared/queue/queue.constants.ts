export const QUEUE_SECTION_SUGGESTION = 'section-suggestion';
export const QUEUE_CAMPAIGN_STRATEGY = 'campaign-strategy';
export const QUEUE_SSL_PROVISION = 'ssl-provision';
