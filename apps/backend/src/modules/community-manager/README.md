...
6. Cada CM guarda `voiceId` / `voiceName` de ElevenLabs y `lipSyncProvider` (`replicate` | `elevenlabs`); la biblioteca expone `GET /products/:id/cm-characters/voices` para el selector en UI.
