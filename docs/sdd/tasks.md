...
- [ ] [P] Implementar endpoint `GET /api/v1/company-profile` para obtener perfil
  **MDD:** §4 GET /api/v1/company-profile
  **Story:** US-007
  **Archivo:** `apps/backend/src/modules/company-profile/company-profile.controller.ts`

- [ ] [P] Implementar endpoint `PATCH /api/v1/company-profile` para actualizar perfil
  **MDD:** §4 PATCH /api/v1/company-profile
  **Story:** US-007
  **Archivo:** `apps/backend/src/modules/company-profile/company-profile.controller.ts`

- [ ] [P] Implementar endpoint `GET /api/v1/company-profile/sections` para listar secciones del cuestionario
  **MDD:** §4 GET /api/v1/company-profile/sections
  **Story:** US-007
  **Archivo:** `apps/backend/src/modules/company-profile/company-profile.controller.ts`

- [ ] [P] Implementar endpoint `PATCH /api/v1/company-profile/sections/:key` para guardar sección
  **MDD:** §4 PATCH /api/v1/company-profile/sections/:key
  **Story:** US-007
  **Archivo:** `apps/backend/src/modules/company-profile/company-profile.controller.ts`

- [ ] [P] Implementar lógica de cálculo de `completion_percentage` y activación al 80%
...
- [ ] [P] Emitir evento `CompanyProfileCompletedEvent` vía outbox al alcanzar 80%
  **MDD:** §2.3, §5.5
  **Story:** US-007
...
- [x] [P] Implementar worker BullMQ para procesar sugerencia IA y guardar resultado
  **Archivo:** `suggestion.worker.ts`, `suggestion.processor.ts`
...
- [x] [P] Crear migraciones para tablas `campaign_templates`, `campaigns`, `budgets`, `audiences`
  **Nota:** TypeORM + `campaign_strategy_assignments`; `synchronize` dev.
...
- [x] [P] CRUD + versiones + revert (`apps/backend/src/modules/content/`)
- [x] [P] Event sourcing tabla `events`; entidades TypeORM + `synchronize` dev
...
- [x] [P] approve / reject / request-changes + SHA-256 + outbox `ContentApproved`
